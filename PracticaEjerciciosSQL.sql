...
values (001, N'000034152', N'Luka', N'Kaneshiro', '02/05/2005', N'luka.kaneshiro@est.uca.edu.ni', N'88885678', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (002, N'000037869', N'Maria', N'Mori', '08/02/2001', N'mariomori@est.uca.edu.ni', N'88789543', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (003, N'000050215', N'Shingeki', N'Kyojin', '01/09/2003', N'shingeki@est.uca.edu.ni', N'56789543', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (004, N'000034756', N'Yuri', N'Mejia', '08/10/2004', N'yurimejia@est.uca.edu.ni', N'56789543', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (009, N'000034896', N'Noruega', N'Mena', '03/03/2006', N'noruegamena@est.uca.edu.ni', N'88546741', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (006, N'000012125', N'Jorge', N'Torres', '02/12/1999', N'jtorres@est.uca.edu.ni', N'57322943', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (007, N'000012547', N'Andre', N'Paz', '03/06/1998', N'andreperez@est.uca.edu.ni', N'88322943', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (008, N'000013568', N'Maya', N'Rayo', '06/08/1992', N'mayarayo@est.uca.edu.ni', N'88262943', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (005, N'000013741', N'Luca', N'Torres', '04/12/2002', N'lucato@est.uca.edu.ni', N'57829943', N'ISI')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (011, N'000052789', N'Marcelo', N'Cruz', '03/14/2007', N'mcruz@est.uca.edu.ni', N'85516241', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (012, N'000020354', N'Avi', N'Parra', '12/24/1992', N'aparra@est.uca.edu.ni', N'85534561', N'CIVIL')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (013, N'000024696', N'Izumi', N'Redentor', '11/04/1995', N'izure@est.uca.edu.ni', N'85524511', N'CIVIL')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (014, N'000020254', N'IMissHer', N'Parrales', '11/04/1995', N'imissher@est.uca.edu.ni', N'85524511', N'CIVIL')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (016, N'000085876', N'Cristina', N'Mendez', '08/24/1991', N'cristina@est.uca.edu.ni', N'55514311', N'CIVIL')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (020, N'000035276', N'Norman', N'Rojas', '05/11/2000', N'normanrojas@est.uca.edu.ni', N'52213511', N'CIVIL')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (029, N'000015426', N'Carolina', N'Rivera', '12/23/2006', N'carolrivera@est.uca.edu.ni', N'53633682', N'INDUSTRIAL')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (037, N'000078154', N'Ivan', N'Torres', '10/18/2001', N'ivantorres@est.uca.edu.ni', N'83691891', N'ARQUITECTURA')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (038, N'0000345854', N'Jorge', N'Joiner', '05/08/2001', N'jorgegarcia@est.uca.edu.ni', N'53691871', N'ARQUITECTURA')
go
...
--Registro clases
insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (001, N'B101', N'Japonés', N'Lunes 2 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (002, N'B102', N'Japonés 2', N'Martes 2 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (003, N'B103', N'Inglés', N'Martes 3 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (004, N'B104', N'Computación', N'Viernes 1 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (005, N'B105', N'Español', N'Viernes 4 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (006, N'B106', N'Deporte', N'Jueves 10 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (007, N'B107', N'Física 2', N'Jueves 11 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (008, N'B108', N'Filosofía', N'Lunes 11 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (009, N'B109', N'Género', N'Martes 11 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (010, N'B110', N'Teología', N'Miercoles 10 a.m')
go
...
insert into Monitores(ID_monitor, ID_estudiante, ID_clase, Anio_en_curso, Semestre_en_curso) values (004, 009, 004, 2023, N'TERCER SEMESTRE')
go
...
insert into Monitores(ID_monitor, ID_estudiante, ID_clase, Anio_en_curso, Semestre_en_curso) values (008, 031, 003, 2023, N'TERCER SEMESTRE')
go
...
insert into Monitores(ID_monitor, ID_estudiante, ID_clase, Anio_en_curso, Semestre_en_curso) values (021, 039, 002, 2023, N'SEGUNDO SEMESTRE')
go
...
insert into Monitores(ID_monitor, ID_estudiante, ID_clase, Anio_en_curso, Semestre_en_curso) values (014, 003, 004, 2023, N'TERCER SEMESTRE')
go
